...
{**************************************************************************************}
{                                                                                      }
{    Function:    FormatMillisecondsToDateTime                                         }
{    Description: The FormatMillisecondsToDateTime function numeric convert a value to }
{    a formatted string result, displaying values with leading zeroes from time field  }
...
{                                                                                      }
{**************************************************************************************}
function TStopWatch.FormatMillisecondsToDateTime(
  const ms: integer): string;
var
  dt : TDateTime;
begin
